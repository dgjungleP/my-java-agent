...
public class MyMethodAdapter extends MethodVisitor {
    ...
    public MyMethodAdapter(String className, int access, String name, String descriptor, MethodVisitor methodVisitor) {
        ...
        this.isStaticMethod = (access & ACC_STATIC) == ACC_STATIC;
    ...
    public void visitCode() {
        ...
        if (paramDescriptions == null) {
            ...
            // 数组的大小
            if (paramDescriptions.length >= 4) {
                mv.visitVarInsn(BIPUSH, paramDescriptions.length);
            } else {
                switch (paramDescriptions.length) {
                    case 1:
            ...
            for (int i = 0; i < paramDescriptions.length; i++) {
                ...
                String type = paramDescriptions[i];
                if ("Z".equals(type)) {
